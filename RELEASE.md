...
- 确认 `viberadio.update.owner/repo` 指向正式仓库。
...
- `dist/Viberadio-1.1.0-Setup.exe.blockmap`（可选；本次不作为旧版软件内更新使用）
...
```json
{
  ...
  "release": {
    "name": "Viberadio v1.1.0-test",
    "downloadUrl": "http://127.0.0.1:3144/Viberadio-1.1.0-Setup.exe",
    "notes": ["本地在线更新链路测试"]
  }
}
```
